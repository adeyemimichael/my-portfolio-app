...
export function CursorAnimation() {
  ...
  return (
    <>
      ...
      <motion.div
        className="fixed top-0 left-0 border-2 border-primary/100 rounded-full pointer-events-none z-[9998] mix-blend-difference"
        style={{
          x: mousePosition.x,
          y: mousePosition.y,
        }}
      ...
      <motion.div
        className="fixed top-0 left-0 bg-primary/80 rounded-full pointer-events-none z-[9997] blur-sm"
        style={{
          x: mousePosition.x,
          y: mousePosition.y,
        }}
